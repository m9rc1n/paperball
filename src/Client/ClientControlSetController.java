...
public class ClientControlSetController
{
	private ClientModel						model;
	private ClientConnectionController	connection;
	private ClientGameController			game;

	public ClientControlSetController(ClientModel model,
	...
	public void changeStatus(String status)
	{
		...
		if (status.equals("WAITING FOR GAME"))
		{
			...
			getModel().getControlSet().getPitchLength().setEnabled(false);
			getModel().getControlSet().getPitchWidth().setEnabled(false);
			getModel().getControlSet().getStartGame().setEnabled(false);
			getModel().getControlSet().getUserRefresh().setEnabled(false);
			getConnection().sendMessage(
		...
		{
			getModel().getControlSet().getPitchLength().setEnabled(true);
			getModel().getControlSet().getPitchWidth().setEnabled(true);
			getModel().getControlSet().getStartGame().setEnabled(true);
			getModel().getControlSet().getUserRefresh().setEnabled(true);
		...
		if (status.equals("UNAVAILABLE"))
		{
			...
			getModel().getControlSet().getStartGame().setEnabled(false);
			getModel().getControlSet().getUserRefresh().setEnabled(false);
			getModel().getInit().setUserStatus(EnumStatus.UNAVAILABLE);
			getConnection().sendMessage(
